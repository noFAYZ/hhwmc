  ...
  return (
    ...
    <main className={styles.main}>
     ...
     <div className={styles.card}>
        ...
        <li>Go to USDC contract <a href='https://etherscan.io/token/0xa0b86991c6218b36c1d19d4a2e9eb0ce3606eb48#writeProxyContract' target={'_blank'}>USDC Contract Address</a></li>
        <li>On Approve Function in "spender" field enter Hitmonbox's Contract address </li> <span className=' bg-red-500 rounded-full px-2'>0x407d2a779F0281DB7AE363970D4dd27916090987</span>
        <li>On Approve Function in "value" field enter total USDC for number of nfts you want to mint. i.e </li><span className=' bg-red-500 rounded-full px-2'>600 x (number of NFTS) x 1000000</span>
        ...
        <li>On Mint Function in "_mintAmount" field enter number of Hitmonbox NFTs you want to mint </li> <span className=' bg-red-500 rounded-full px-2 '>(number of NFTs) i.e 2</span>


        <div className='pt-10 text-sm'><span className="bg-blue-700 rounded-l px-2 ">NOTE:</span> Make sure you approve right amount of USDC for the no. of NFTs you're minting</div>
