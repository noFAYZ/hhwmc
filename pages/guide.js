  ...
  return (
    ...
    <main className={styles.main}>
     ...
     <div className={styles.card}>
        ...
        <li  className='pt-1'>On Approve Function in <span className='bg-blue-500 px-1 rounded'>spender</span> field enter Hitmonbox's Contract address </li> <span className=' bg-red-500 rounded-full px-2'>0x407d2a779F0281DB7AE363970D4dd27916090987</span>
